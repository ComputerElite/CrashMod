...
DECLARE_CONFIG(ModConfig,
    ...
    DECLARE_VALUE(Percentage, float, "Percentage", 0.9);
    ...
    DECLARE_VALUE(CrashOnOver5PerBattery, bool, "Crash the game if you have more battery life than the threshold above", 5);
